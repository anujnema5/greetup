...
import { CIRCLES_BROWSE_TABS } from "../../constants/circles-browse-copy";
import type { CirclesBrowseTab } from "../../types/circles-browse.types";

const TAB_ICONS: Record<CirclesBrowseTab, typeof LayoutGrid> = {
  all: LayoutGrid,
  invited: UserRound,
  mine: UsersRound,
  discover: Compass,
