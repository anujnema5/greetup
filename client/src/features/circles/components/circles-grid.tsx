...
import { CIRCLES } from "@/features/dashboard/constants/mock-data";
      ...
      >
        {CIRCLES.map((c) => (
          <div
            ...
            style={{
              boxShadow:
                "0 1px 0 0 rgba(255,255,255,0.08) inset, 0 4px 20px rgba(0,0,0,0.4)",
            }}
          >
