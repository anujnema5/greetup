 ...
 * black frames. {@link RoomVideoStage} fixes this with off-screen 320×180 decode sinks + VideoMirror;
 * the minimized dock must do the same while the call is floating over other routes.
 */
import { useRef, type RefObject } from "react";
import { VideoMirror } from "@/features/room/components/room-video/room-video-primitives";
