...
import { TryStepper } from "./try-stepper";
...
export function TryLayout({
  ...
  const stepperFurthest: TryWizardStep | null =
    ...
    (activeStep && isTryWizardStep(activeStep) ? activeStep : null);
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto flex min-h-dvh w-full max-w-7xl flex-col px-5 py-6 sm:px-8 lg:px-10 lg:py-8">
        ...
        <header className="mb-6 flex shrink-0 items-center justify-between gap-4 lg:mb-8">
        ...
        <div
          ...
          className={cn(
            ...
            showStepper &&
              ...
              "lg:grid lg:grid-cols-[minmax(240px,300px)_minmax(0,1fr)] lg:items-start lg:gap-12 xl:gap-16",
