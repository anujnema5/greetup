...
export function RoomInviteSettingsModal({
  ...
  const friendlySummary = useMemo(() => {
    if (policy === "all_connections") {
      return "Your friends on Greetup can add you when they start a space and send invites.";
    }
  ...
  return (
    <ProfileEditShell
      ...
      title="Who can invite you to a space?"
      description="When a friend creates a space and adds people, you decide who is allowed to include you on that list."
      footer={footer}
    >
          ...
          >
            ...
            <span className="min-w-0 pt-0.5">
              ...
              <span className="mt-1 block text-[12px] text-muted-foreground leading-snug">
                Any friend you’re connected with can add you when they set up a space.
              </span>
            </span>
          </button>
