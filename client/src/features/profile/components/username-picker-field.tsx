      ...
      <div className="space-y-2">
        ...
        >
          <Input
            ...
            className="h-full min-w-0 flex-1 rounded-none border-0 bg-transparent px-3 text-base shadow-none placeholder:text-[13px] sm:placeholder:text-[13px] focus-visible:ring-0 dark:bg-transparent"
          />
          <Button
            type="button"
            variant="ghost"
