...
type SpacesBrowseFooterProps = {
  isRefreshing: boolean;
  onRefresh: () => void;
};

export function SpacesBrowseFooter({ isRefreshing, onRefresh }: SpacesBrowseFooterProps) {
  return (
    <footer className="flex flex-col items-center gap-2 border-t border-border/50 pt-6">
      ...
      >
        ...
        {isRefreshing ? SPACES_BROWSE_PAGE.refreshing : SPACES_BROWSE_PAGE.refresh}
      </Button>
    </footer>
  );
}
