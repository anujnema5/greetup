...
export default function AuthPageLayout({
  ...
  return (
    <div className="relative h-dvh w-full overflow-x-hidden overflow-y-auto bg-linear-to-br from-background via-background to-muted/20">
      {backHref ? (
        <Link
          href={backHref}
      ...
      <div className="mx-auto flex min-h-full w-full max-w-7xl items-center px-6 py-16 lg:h-full lg:min-h-0 lg:px-8 lg:py-8">
        <div className="grid w-full gap-8 lg:h-full lg:grid-cols-2 lg:gap-12">
              ...
              <div className="border-t border-border/60 pt-3">
                <p className="text-center text-sm text-muted-foreground">
                  ...
                  <button
                    ...
                    className="cursor-pointer rounded-sm font-semibold text-primary underline-offset-4 transition-all hover:text-primary/80 hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
                  >
                    {footerLinkText}
                  </button>
                </p>
          ...
          <aside
            ...
            className="hidden min-h-0 lg:flex lg:items-stretch"
          >
            <div className="relative w-full overflow-hidden rounded-2xl border-2 bg-linear-to-br from-primary/10 via-primary/5 to-background shadow-2xl backdrop-blur-sm">
